...
const Aseguradora = props => (
  <Tr>
    ...
    {(props.session.esAdmin ? <Td><button className={"btn " + (props.aseguradora.estado ? 'btn-danger' : 'btn-success' )} onClick={()=>props.component.confirmDialog(props.aseguradora._id)}>{(props.aseguradora.estado ? 'Deshabilitar' : 'Habilitar')}</button></Td>: "")}
